...
Active tasks:  P1.1 gate-scope split packet required after shell-harness review; separate gate-harness design from ADR acceptance; preserve AE-P0.1/AE-P0.2 evidence and track F1-F3 follow-ups
