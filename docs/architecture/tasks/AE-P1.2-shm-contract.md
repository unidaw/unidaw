...
`tools/p12_selfcheck.py` at this SHA, PREV PACKET BLOB `59b8e226ccae4f75f5f17b4f76e9f4af336003ab`, A.0 SCRIPT BLOB `d599c7a4163f80b3516c52c7e45a33e64ff7a77e`
...
**Controls.** One hundred eighteen, each naming the tag it must provoke; a control that mutates the file without
