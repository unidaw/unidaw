...
`tools/p12_selfcheck.py` at this SHA, PREV PACKET BLOB `11b40ddea4598e774b243ca8490bf0d902137f16`, A.0 SCRIPT BLOB `7a76a17d958534b2ea642d964ed0ab7621964b59`
...
**Controls.** Eighty-eight, each naming the tag it must provoke; a control that mutates the file without
