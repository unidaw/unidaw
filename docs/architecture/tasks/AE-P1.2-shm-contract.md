...
`tools/p12_selfcheck.py` at this SHA, PREV PACKET BLOB `2ca6068383955a8a72d9eb51bd07d61470a26f0d`, A.0 SCRIPT BLOB `a76ae3f1420608ab5a6fc65f2715b3e04d63376b`
...
**Controls.** One hundred fifteen, each naming the tag it must provoke; a control that mutates the file without
