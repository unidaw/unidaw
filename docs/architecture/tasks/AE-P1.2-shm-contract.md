...
`tools/p12_selfcheck.py` at this SHA, PREV PACKET BLOB `4e9dfee15f8e1945dc0a938e180b293648726ea9`, A.0 SCRIPT BLOB `2e53531f701228019279a27a356662661342193d`
...
**Controls.** One hundred seventy-three, each naming the tag it must provoke; a control that mutates the file without
