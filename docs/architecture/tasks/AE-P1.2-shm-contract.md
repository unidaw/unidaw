...
`tools/p12_selfcheck.py` at this SHA, PREV PACKET BLOB `92d923bce6dfd52af5750bacba73f8ec057a7fac`, A.0 SCRIPT BLOB `d51c0df7bb58bb1c6ae5d0674e658615b2197f98`
...
**Controls.** One hundred seventeen, each naming the tag it must provoke; a control that mutates the file without
