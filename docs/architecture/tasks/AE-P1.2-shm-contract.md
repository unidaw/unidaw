...
`tools/p12_selfcheck.py` at this SHA, PREV PACKET BLOB `ad1335a0bb74eccb809c0da4612a5833aab71fac`, A.0 SCRIPT BLOB `0b63a50d690f7a7c4bbf58fb1b5e4f91214e9294`
...
**Controls.** One hundred twenty-one, each naming the tag it must provoke; a control that mutates the file without
