 ...
 * suite that invokes daw-cli. Pinned so the number can only go down. It is 7 now. time-sig,
...
const CLI_NEVER_EXERCISED = [
  'audio-clip', 'patcher-config', 'patcher-save', 'position', 'sampler-emit-rows',
  'sampler-env-draw', 'scratch',
];
